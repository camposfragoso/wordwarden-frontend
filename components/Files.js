...
function Files() {
  ...
  //how files display
  const filesDisplay = files.map((el, index)=>{
    return(
      <File key={index} title={el.title} lastModified={el.lastModified} activeAssistants={el.activeAssistants} content={el.content}/>
    )
  })
